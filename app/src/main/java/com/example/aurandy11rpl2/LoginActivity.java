    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                if (txtusername.getText().toString().equalsIgnoreCase("randy") && txtpassword.getText().toString().equals("randy123")){
                    Intent in = new Intent(LoginActivity.this,MainMenuActivity.class);
                    Toast.makeText(LoginActivity.this, "Welcome tamu", Toast.LENGTH_SHORT).show();
                    startActivity(in);
                    finish();
